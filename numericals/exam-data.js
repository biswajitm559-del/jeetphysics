...
// ============================================================================
//  EXAM-DATA.JS â€” Physics Numerical Solutions Portal
...
// ---------------------------------------------------------------------------
//  2. EXAM PROBLEMS â€” 40 problems (5 per exam), with full solutions
// ---------------------------------------------------------------------------

const EXAM_PROBLEMS = {

    // ===== JEE MAIN â€” 5 Problems ===========================================
    'jee-main': [
        {
            id: 1,
            exam: 'jee-main',
            ...
            difficulty: 'easy',
            year: '2023',
            question: 'A ball is thrown from the ground at an angle of 45Â° with the horizontal with an initial velocity of 20 m/s. Assuming no air resistance and g = 9.8 m/sÂ², find the horizontal range of the projectile.',
            given: 'Given: Initial velocity u = 20 m/s, Angle of projection Î¸ = 45Â°, g = 9.8 m/sÂ²',
            required: 'Find: Horizontal range R',
            formula: '$$R = \\frac{u^2 \\sin 2\\theta}{g}$$',
            steps: [
                'Step 1: Identify the range formula for projectile motion: R = uÂ² sin(2Î¸) / g',
                'Step 2: Substitute Î¸ = 45Â°, so sin(2 Ã— 45Â°) = sin 90Â° = 1',
                'Step 3: R = (20)Â² Ã— 1 / 9.8 = 400 / 9.8',
                'Step 4: R = 40.82 m'
            ],
            answer: 'R â‰ˆ 40.8 m',
            notes: 'Maximum range is obtained at Î¸ = 45Â° for a given speed. This is one of the most frequently asked concepts in JEE Main Mechanics.'
        },
        {
            id: 2,
            exam: 'jee-main',
            ...
            difficulty: 'moderate',
            year: '2022',
            question: 'Two point charges +3 Î¼C and âˆ’3 Î¼C are placed 20 cm apart. Find the magnitude of the electric field at the midpoint of the line joining the two charges.',
            given: 'Given: qâ‚ = +3 Î¼C = 3 Ã— 10â»â¶ C, qâ‚‚ = âˆ’3 Î¼C = âˆ’3 Ã— 10â»â¶ C, separation d = 20 cm = 0.2 m, k = 9 Ã— 10â¹ NÂ·mÂ²/CÂ²',
            ...
            steps: [
                ...
                'Step 2: Electric field due to +3 Î¼C at midpoint: Eâ‚ = kq/rÂ² = 9Ã—10â¹ Ã— 3Ã—10â»â¶ / (0.1)Â² = 2.7 Ã— 10â¶ N/C (pointing away from +q)',
                'Step 3: Electric field due to âˆ’3 Î¼C at midpoint: Eâ‚‚ = kq/rÂ² = 2.7 Ã— 10â¶ N/C (pointing toward âˆ’q)',
                'Step 4: Both fields point in the same direction (from + to âˆ’), so E_net = Eâ‚ + Eâ‚‚ = 5.4 Ã— 10â¶ N/C'
            ],
            answer: 'E = 5.4 Ã— 10â¶ N/C',
        ...
        },
        {
            ...
            given: 'Given: Object distance u = âˆ’30 cm (sign convention), Focal length f = +20 cm (convex lens)',
            required: 'Find: Image distance v and nature of image',
            formula: '$$\\frac{1}{v} - \\frac{1}{u} = \\frac{1}{f}$$',
            steps: [
                'Step 1: Apply the thin lens formula: 1/v âˆ’ 1/u = 1/f',
                'Step 2: Substitute values: 1/v âˆ’ 1/(âˆ’30) = 1/20',
                'Step 3: 1/v + 1/30 = 1/20',
                'Step 4: 1/v = 1/20 âˆ’ 1/30 = (3 âˆ’ 2)/60 = 1/60',
                'Step 5: v = +60 cm (positive sign means real image on the other side of the lens)'
            ],
            answer: 'v = +60 cm, real and inverted image, magnification m = v/u = 60/(âˆ’30) = âˆ’2 (magnified)',
        ...
        },
        {
            ...
            given: 'Given: Wavelength Î» = 400 nm = 400 Ã— 10â»â¹ m, Work function Ï† = 2.0 eV, h = 6.626 Ã— 10â»Â³â´ JÂ·s, c = 3 Ã— 10â¸ m/s, 1 eV = 1.6 Ã— 10â»Â¹â¹ J',
            required: 'Find: Maximum kinetic energy KE_max of photoelectrons',
            formula: '$$KE_{\\max} = \\frac{hc}{\\lambda} - \\phi$$',
            steps: [
                'Step 1: Calculate the energy of the incident photon: E = hc/Î»',
                'Step 2: E = (6.626 Ã— 10â»Â³â´ Ã— 3 Ã— 10â¸) / (400 Ã— 10â»â¹) = 4.97 Ã— 10â»Â¹â¹ J',
                'Step 3: Convert to eV: E = 4.97 Ã— 10â»Â¹â¹ / 1.6 Ã— 10â»Â¹â¹ = 3.1 eV',
                'Step 4: Apply Einstein\'s photoelectric equation: KE_max = E âˆ’ Ï† = 3.1 âˆ’ 2.0 = 1.1 eV'
            ],
            answer: 'KE_max = 1.1 eV',
            notes: 'The threshold wavelength for this metal is Î»â‚€ = hc/Ï† = 1240/2.0 = 620 nm. Any light with Î» < 620 nm will cause photoemission. This is a standard JEE Main numerical.'
        },
        {
            id: 5,
            exam: 'jee-main',
            ...
            given: 'Given: n = 2 mol, T = 300 K, Vâ‚‚ = 2Vâ‚, R = 8.314 J/(molÂ·K)',
            required: 'Find: Work done W by the gas',
            formula: '$$W = nRT \\ln\\left(\\frac{V_2}{V_1}\\right)$$',
            steps: [
                'Step 1: For an isothermal process, work done W = nRT ln(Vâ‚‚/Vâ‚)',
                'Step 2: Substitute Vâ‚‚/Vâ‚ = 2, so ln(2) = 0.693',
                'Step 3: W = 2 Ã— 8.314 Ã— 300 Ã— 0.693',
                'Step 4: W = 2 Ã— 8.314 Ã— 300 Ã— 0.693 = 3458.1 J â‰ˆ 3.46 kJ'
            ],
            answer: 'W â‰ˆ 3458 J â‰ˆ 3.46 kJ',
            notes: 'In isothermal expansion, the gas does positive work on the surroundings. The internal energy remains constant (Î”U = 0) and the heat absorbed equals the work done: Q = W.'
        }
    ],
    ...
    'neet': [
        {
            ...
            steps: [
                'Step 1: The time period of a mass-spring system is T = 2Ï€âˆš(m/k)',
                'Step 2: Substitute: T = 2Ï€âˆš(0.5/200) = 2Ï€âˆš(0.0025)',
                'Step 3: T = 2Ï€ Ã— 0.05 = 2 Ã— 3.1416 Ã— 0.05',
                'Step 4: T = 0.314 s'
            ],
            answer: 'T â‰ˆ 0.314 s',
        ...
        },
        {
            ...
            given: 'Given: Object distance u = âˆ’15 cm (sign convention), Focal length f = âˆ’10 cm (concave mirror)',
            required: 'Find: Image distance v, nature, and magnification m',
            formula: '$$\\frac{1}{v} + \\frac{1}{u} = \\frac{1}{f}$$',
            steps: [
                'Step 1: Apply mirror formula: 1/v + 1/u = 1/f',
                'Step 2: 1/v + 1/(âˆ’15) = 1/(âˆ’10)',
                'Step 3: 1/v = âˆ’1/10 + 1/15 = (âˆ’3 + 2)/30 = âˆ’1/30',
                'Step 4: v = âˆ’30 cm (negative sign â†’ real image, same side as object)',
                'Step 5: Magnification m = âˆ’v/u = âˆ’(âˆ’30)/(âˆ’15) = âˆ’2 (inverted and magnified)'
            ],
            answer: 'v = âˆ’30 cm, real, inverted image with magnification |m| = 2',
        ...
        },
        {
            ...
            difficulty: 'moderate',
            year: '2023',
            question: 'Three resistors of 2 Î©, 3 Î© and 6 Î© are connected in parallel. Find the equivalent resistance of the combination.',
            given: 'Given: Râ‚ = 2 Î©, Râ‚‚ = 3 Î©, Râ‚ƒ = 6 Î©, connected in parallel',
            required: 'Find: Equivalent resistance R_eq',
            formula: '$$\\frac{1}{R_{eq}} = \\frac{1}{R_1} + \\frac{1}{R_2} + \\frac{1}{R_3}$$',
            steps: [
                'Step 1: For parallel combination: 1/R_eq = 1/Râ‚ + 1/Râ‚‚ + 1/Râ‚ƒ',
                'Step 2: 1/R_eq = 1/2 + 1/3 + 1/6',
                'Step 3: Find LCM of 2, 3, 6 â†’ LCM = 6',
                'Step 4: 1/R_eq = 3/6 + 2/6 + 1/6 = 6/6 = 1',
                'Step 5: R_eq = 1 Î©'
            ],
            answer: 'R_eq = 1 Î©',
            notes: 'The equivalent resistance of a parallel combination is always less than the smallest individual resistance. Here, R_eq = 1 Î© < 2 Î© (the smallest resistor). This is a very commonly asked NEET problem.'
        },
        {
            id: 4,
            exam: 'neet',
            chapter: 'Atomic Physics',
            topic: 'Hydrogen Spectrum â€“ Balmer Series',
            difficulty: 'easy',
            year: '2022',
            question: 'Calculate the wavelength of light emitted when a hydrogen atom makes a transition from n = 3 to n = 2 energy level. (Rydberg constant R = 1.097 Ã— 10â· mâ»Â¹)',
            given: 'Given: nâ‚ = 2, nâ‚‚ = 3, R = 1.097 Ã— 10â· mâ»Â¹',
            required: 'Find: Wavelength Î» of emitted photon',
            formula: '$$\\frac{1}{\\lambda} = R\\left(\\frac{1}{n_1^2} - \\frac{1}{n_2^2}\\right)$$',
            steps: [
                'Step 1: Apply the Rydberg formula: 1/Î» = R(1/nâ‚Â² âˆ’ 1/nâ‚‚Â²)',
                'Step 2: 1/Î» = 1.097 Ã— 10â· Ã— (1/4 âˆ’ 1/9)',
                'Step 3: 1/4 âˆ’ 1/9 = (9 âˆ’ 4)/36 = 5/36',
                'Step 4: 1/Î» = 1.097 Ã— 10â· Ã— 5/36 = 1.524 Ã— 10â¶ mâ»Â¹',
                'Step 5: Î» = 1 / (1.524 Ã— 10â¶) = 656.3 Ã— 10â»â¹ m = 656 nm'
            ],
            answer: 'Î» â‰ˆ 656 nm (red light â€” HÎ± line of Balmer series)',
            notes: 'The transition from n = 3 â†’ n = 2 produces the first line of the Balmer series (HÎ±), which falls in the visible red region. This is the most prominent line in the hydrogen emission spectrum.'
        },
        {
            id: 5,
            exam: 'neet',
            chapter: 'Heat & Thermodynamics',
            topic: 'Calorimetry â€“ Ice-Water Mixing',
            difficulty: 'moderate',
            year: '2023',
            question: '100 g of ice at 0Â°C is mixed with 200 g of water at 50Â°C in a calorimeter. Find the final temperature of the mixture. (Latent heat of fusion L = 80 cal/g, Specific heat of water c = 1 cal/gÂ·Â°C)',
            given: 'Given: m_ice = 100 g at 0Â°C, m_water = 200 g at 50Â°C, L = 80 cal/g, c = 1 cal/gÂ·Â°C',
            required: 'Find: Final equilibrium temperature T_f',
            formula: '$$m_{ice} \\cdot L + m_{ice} \\cdot c \\cdot T_f = m_{water} \\cdot c \\cdot (50 - T_f)$$',
            steps: [
                'Step 1: Heat needed to melt all ice: Q_melt = m_ice Ã— L = 100 Ã— 80 = 8000 cal',
                'Step 2: Heat available from water cooling to 0Â°C: Q_avail = 200 Ã— 1 Ã— 50 = 10000 cal',
                'Step 3: Since Q_avail (10000) > Q_melt (8000), all ice melts. Remaining heat = 10000 âˆ’ 8000 = 2000 cal',
                'Step 4: This remaining heat warms the total water (100 + 200 = 300 g) from 0Â°C to T_f',
                'Step 5: 2000 = 300 Ã— 1 Ã— T_f â†’ T_f = 2000/300 = 6.67Â°C'
            ],
            answer: 'T_f â‰ˆ 6.67Â°C',
            notes: 'Always first check whether the available heat is sufficient to melt all the ice. If not, the final temperature would be 0Â°C with some ice remaining. Here, all ice melts and the mixture equilibrates above 0Â°C.'
        }
    ],

    // ===== IIT JAM PHYSICS â€” 5 Problems ======================================
    'jam-physics': [
        {
            id: 1,
            exam: 'jam-physics',
            ...
            difficulty: 'moderate',
            year: null,
            question: 'Using the Lagrangian formulation, derive the equation of motion for a simple pendulum of length l and mass m. Write the Lagrangian and apply the Eulerâ€“Lagrange equation.',
            given: 'Given: Pendulum of length l, mass m, gravitational acceleration g. Generalized coordinate: angle Î¸',
            required: 'Find: Equation of motion using Lagrangian mechanics',
            formula: '$$L = T - V = \\frac{1}{2}ml^2\\dot{\\theta}^2 + mgl\\cos\\theta$$',
            steps: [
                'Step 1: Kinetic energy T = Â½m(lÎ¸Ì‡)Â² = Â½mlÂ²Î¸Ì‡Â²',
                'Step 2: Potential energy V = âˆ’mgl cos Î¸ (taking lowest point as reference gives V = mgl(1 âˆ’ cos Î¸), but using pivot as reference: V = âˆ’mgl cos Î¸)',
                'Step 3: Lagrangian L = T âˆ’ V = Â½mlÂ²Î¸Ì‡Â² + mgl cos Î¸',
                'Step 4: Eulerâ€“Lagrange equation: d/dt(âˆ‚L/âˆ‚Î¸Ì‡) âˆ’ âˆ‚L/âˆ‚Î¸ = 0',
                'Step 5: âˆ‚L/âˆ‚Î¸Ì‡ = mlÂ²Î¸Ì‡ â†’ d/dt(mlÂ²Î¸Ì‡) = mlÂ²Î¸Ìˆ',
                'Step 6: âˆ‚L/âˆ‚Î¸ = âˆ’mgl sin Î¸',
                'Step 7: mlÂ²Î¸Ìˆ + mgl sin Î¸ = 0 â†’ Î¸Ìˆ + (g/l) sin Î¸ = 0'
            ],
            answer: 'Î¸Ìˆ + (g/l) sin Î¸ = 0; for small oscillations sin Î¸ â‰ˆ Î¸, giving SHM with Ï‰ = âˆš(g/l)',
            notes: 'The Lagrangian approach is powerful because it works naturally with generalized coordinates and avoids the need to resolve forces. For small angles, this reduces to Î¸Ìˆ + (g/l)Î¸ = 0 with period T = 2Ï€âˆš(l/g).'
        },
        {
            id: 2,
            exam: 'jam-physics',
            ...
            given: 'Given: L = 2 nm = 2 Ã— 10â»â¹ m, m_e = 9.109 Ã— 10â»Â³Â¹ kg, â„ = 1.055 Ã— 10â»Â³â´ JÂ·s',
            required: 'Find: Energy gap Î”E = Eâ‚‚ âˆ’ Eâ‚',
            formula: '$$E_n = \\frac{n^2 \\pi^2 \\hbar^2}{2mL^2}, \\quad \\Delta E = \\frac{3\\pi^2\\hbar^2}{2mL^2}$$',
            steps: [
                'Step 1: Energy levels: Eâ‚™ = nÂ²Ï€Â²â„Â²/(2mLÂ²)',
                'Step 2: Î”E = Eâ‚‚ âˆ’ Eâ‚ = (4 âˆ’ 1)Ï€Â²â„Â²/(2mLÂ²) = 3Ï€Â²â„Â²/(2mLÂ²)',
                'Step 3: Numerator: 3 Ã— (3.1416)Â² Ã— (1.055 Ã— 10â»Â³â´)Â² = 3 Ã— 9.87 Ã— 1.113 Ã— 10â»â¶â¸ = 3.295 Ã— 10â»â¶â· JÂ²Â·sÂ²',
                'Step 4: Denominator: 2 Ã— 9.109 Ã— 10â»Â³Â¹ Ã— (2 Ã— 10â»â¹)Â² = 2 Ã— 9.109 Ã— 10â»Â³Â¹ Ã— 4 Ã— 10â»Â¹â¸ = 7.287 Ã— 10â»â´â¸ kgÂ·mÂ²',
                'Step 5: Î”E = 3.295 Ã— 10â»â¶â· / 7.287 Ã— 10â»â´â¸ = 4.52 Ã— 10â»Â²â° J â‰ˆ 0.283 eV'
            ],
            answer: 'Î”E â‰ˆ 0.283 eV',
            notes: 'The energy levels of a particle in a box scale as nÂ². The spacing increases with n, unlike the harmonic oscillator where spacing is constant. Smaller box â†’ larger energy gap (quantum confinement).'
        },
        {
            id: 3,
            exam: 'jam-physics',
            ...
            difficulty: 'advanced',
            year: null,
            question: 'An infinitely long straight wire carries a uniform linear charge density Î» = 10 nC/m. Using Gauss\'s law, find the electric field at a perpendicular distance r = 5 cm from the wire.',
            given: 'Given: Î» = 10 nC/m = 10 Ã— 10â»â¹ C/m, r = 5 cm = 0.05 m, Îµâ‚€ = 8.854 Ã— 10â»Â¹Â² CÂ²/(NÂ·mÂ²)',
            ...
            steps: [
                ...
                'Step 3: Gauss\'s law: âˆ® Eâƒ—Â·dAâƒ— = Q_enc/Îµâ‚€ â†’ E(2Ï€rL) = Î»L/Îµâ‚€',
                'Step 4: E = Î»/(2Ï€Îµâ‚€r) = 10 Ã— 10â»â¹ / (2Ï€ Ã— 8.854 Ã— 10â»Â¹Â² Ã— 0.05)',
                'Step 5: E = 10â»â¸ / (2.783 Ã— 10â»Â¹Â²) = 3593 V/m â‰ˆ 3.6 kV/m'
            ],
            answer: 'E â‰ˆ 3593 V/m â‰ˆ 3.6 kV/m, directed radially outward',
            notes: 'The electric field of an infinite line charge falls off as 1/r (not 1/rÂ² as for a point charge). This is because the field lines spread in two dimensions only (cylindrical symmetry), not three.'
        },
        {
            id: 4,
            exam: 'jam-physics',
            ...
            difficulty: 'easy',
            year: null,
            question: 'For one mole of an ideal monatomic gas, the molar heat capacity at constant volume is Cáµ¥ = 3R/2. Find the molar heat capacity at constant pressure Câ‚š and the adiabatic index Î³.',
            given: 'Given: Cáµ¥ = 3R/2 for monatomic ideal gas, R = 8.314 J/(molÂ·K)',
            required: 'Find: Câ‚š and Î³ = Câ‚š/Cáµ¥',
            formula: '$$C_p = C_v + R, \\quad \\gamma = \\frac{C_p}{C_v}$$',
            steps: [
                'Step 1: Apply Mayer\'s relation: Câ‚š âˆ’ Cáµ¥ = R (for any ideal gas)',
                'Step 2: Câ‚š = Cáµ¥ + R = 3R/2 + R = 5R/2',
                'Step 3: In SI units: Câ‚š = 5 Ã— 8.314/2 = 20.785 J/(molÂ·K)',
                'Step 4: Î³ = Câ‚š/Cáµ¥ = (5R/2)/(3R/2) = 5/3 â‰ˆ 1.667'
            ],
            answer: 'Câ‚š = 5R/2 â‰ˆ 20.8 J/(molÂ·K), Î³ = 5/3 â‰ˆ 1.667',
            notes: 'Monatomic gases (He, Ne, Ar) have Î³ = 5/3. Diatomic gases at moderate temperatures have Î³ = 7/5 = 1.4 (e.g., Nâ‚‚, Oâ‚‚). The value of Î³ determines the speed of sound and adiabatic processes.'
        },
        {
            id: 5,
            exam: 'jam-physics',
            ...
            difficulty: 'easy',
            year: null,
            question: 'Two springs with spring constants kâ‚ = 100 N/m and kâ‚‚ = 200 N/m are connected in series. Find the effective spring constant of the combination.',
            given: 'Given: kâ‚ = 100 N/m, kâ‚‚ = 200 N/m, connected in series',
            ...
            steps: [
                ...
                'Step 2: 1/k_eff = 1/kâ‚ + 1/kâ‚‚ = 1/100 + 1/200',
                'Step 3: 1/k_eff = 2/200 + 1/200 = 3/200',
                'Step 4: k_eff = 200/3 = 66.67 N/m'
            ],
            answer: 'k_eff â‰ˆ 66.7 N/m',
            notes: 'Springs in series are softer (lower k) than either individual spring, similar to resistors in parallel. Springs in parallel add directly: k_eff = kâ‚ + kâ‚‚. This analogy with electrical circuits is useful to remember.'
        }
    ],

    // ===== IIT JAM CHEMISTRY â€” 5 Problems ====================================
    'jam-chemistry': [
        {
            id: 1,
            exam: 'jam-chemistry',
            ...
            difficulty: 'easy',
            year: null,
            question: 'For the combustion of hydrogen: Hâ‚‚(g) + Â½Oâ‚‚(g) â†’ Hâ‚‚O(l), Î”H = âˆ’285.8 kJ/mol and Î”S = âˆ’0.163 kJ/(molÂ·K) at 298 K. Calculate the Gibbs free energy change Î”G.',
            given: 'Given: Î”H = âˆ’285.8 kJ/mol, Î”S = âˆ’0.163 kJ/(molÂ·K), T = 298 K',
            required: 'Find: Î”G for the reaction',
            formula: '$$\\Delta G = \\Delta H - T\\Delta S$$',
            steps: [
                'Step 1: Apply the Gibbsâ€“Helmholtz equation: Î”G = Î”H âˆ’ TÎ”S',
                'Step 2: Î”G = âˆ’285.8 âˆ’ (298)(âˆ’0.163)',
                'Step 3: Î”G = âˆ’285.8 + 48.57',
                'Step 4: Î”G = âˆ’237.2 kJ/mol'
            ],
            answer: 'Î”G = âˆ’237.2 kJ/mol',
            notes: 'A negative Î”G indicates a spontaneous reaction. Despite the decrease in entropy (Î”S < 0, as gas â†’ liquid), the large exothermic enthalpy drives the reaction spontaneously at 298 K. This is the standard free energy of formation of liquid water.'
        },
        {
            id: 2,
            exam: 'jam-chemistry',
            ...
            difficulty: 'moderate',
            year: null,
            question: 'A first-order reaction has a rate constant k = 0.0693 minâ»Â¹. Calculate the half-life of the reaction and the time required for 75% completion.',
            given: 'Given: Rate constant k = 0.0693 minâ»Â¹, first-order reaction',
            required: 'Find: Half-life tâ‚/â‚‚ and time for 75% completion',
            formula: '$$t_{1/2} = \\frac{0.693}{k}, \\quad t = \\frac{2.303}{k}\\log\\frac{[A]_0}{[A]}$$',
            steps: [
                'Step 1: Half-life: tâ‚/â‚‚ = 0.693/k = 0.693/0.0693 = 10 min',
                'Step 2: For 75% completion, 25% remains: [A] = 0.25[A]â‚€',
                'Step 3: t = (2.303/k) Ã— log([A]â‚€/[A]) = (2.303/0.0693) Ã— log(1/0.25)',
                'Step 4: t = 33.24 Ã— log(4) = 33.24 Ã— 0.602 = 20 min',
                'Step 5: Alternatively, 75% completion = 2 half-lives: t = 2 Ã— 10 = 20 min âœ“'
            ],
            answer: 'tâ‚/â‚‚ = 10 min; time for 75% completion = 20 min',
        ...
        },
        {
            ...
            topic: 'Particle in a Box â€“ Transition Wavelength',
            difficulty: 'moderate',
            year: null,
            ...
            given: 'Given: L = 1 nm = 10â»â¹ m, m_e = 9.109 Ã— 10â»Â³Â¹ kg, h = 6.626 Ã— 10â»Â³â´ JÂ·s, c = 3 Ã— 10â¸ m/s',
            required: 'Find: Wavelength Î» of emitted photon',
            formula: '$$\\Delta E = \\frac{3h^2}{8mL^2}, \\quad \\lambda = \\frac{hc}{\\Delta E}$$',
            steps: [
                'Step 1: Energy of level n: Eâ‚™ = nÂ²hÂ²/(8mLÂ²)',
                'Step 2: Î”E = Eâ‚‚ âˆ’ Eâ‚ = (4âˆ’1)hÂ²/(8mLÂ²) = 3hÂ²/(8mLÂ²)',
                'Step 3: Î”E = 3 Ã— (6.626Ã—10â»Â³â´)Â² / (8 Ã— 9.109Ã—10â»Â³Â¹ Ã— (10â»â¹)Â²)',
                'Step 4: Î”E = 3 Ã— 4.39Ã—10â»â¶â· / (7.287Ã—10â»â´â¸) = 1.81 Ã— 10â»Â¹â¹ J = 1.13 eV',
                'Step 5: Î» = hc/Î”E = (6.626Ã—10â»Â³â´ Ã— 3Ã—10â¸) / 1.81Ã—10â»Â¹â¹ = 1.098 Ã— 10â»â¶ m â‰ˆ 1098 nm (near-IR)'
            ],
            answer: 'Î» â‰ˆ 1098 nm (near-infrared)',
        ...
        },
        {
            ...
            difficulty: 'easy',
            year: null,
            question: 'A galvanic cell has a standard cell potential EÂ°_cell = 1.1 V and the cell reaction involves the transfer of 2 electrons. Calculate the standard Gibbs free energy change Î”GÂ°.',
            given: 'Given: EÂ°_cell = 1.1 V, n = 2 (electrons transferred), F = 96485 C/mol',
            required: 'Find: Î”GÂ° for the cell reaction',
            formula: '$$\\Delta G^\\circ = -nFE^\\circ_{cell}$$',
            steps: [
                'Step 1: Apply the relation Î”GÂ° = âˆ’nFEÂ°',
                'Step 2: Î”GÂ° = âˆ’2 Ã— 96485 Ã— 1.1',
                'Step 3: Î”GÂ° = âˆ’2 Ã— 106133.5',
                'Step 4: Î”GÂ° = âˆ’212267 J = âˆ’212.3 kJ/mol'
            ],
            answer: 'Î”GÂ° = âˆ’212.3 kJ/mol',
            notes: 'The negative Î”GÂ° confirms that the galvanic cell reaction is spontaneous under standard conditions. This is the Daniell cell (Zn-Cu) standard potential. The equilibrium constant can be found from: ln K = nFEÂ°/(RT).'
        },
        {
            id: 5,
            exam: 'jam-chemistry',
            ...
            difficulty: 'easy',
            year: null,
            question: '18 g of glucose (Câ‚†Hâ‚â‚‚Oâ‚†, M = 180 g/mol) is dissolved in 1 kg of water. Find the molality of the solution and the elevation in boiling point. (Kb for water = 0.512 Â°C/m)',
            given: 'Given: Mass of glucose = 18 g, Molar mass M = 180 g/mol, Mass of solvent = 1 kg, Kb = 0.512 Â°CÂ·kg/mol',
            required: 'Find: Molality m and boiling point elevation Î”Tb',
            ...
            steps: [
                ...
                'Step 3: Boiling point elevation: Î”Tb = Kb Ã— m = 0.512 Ã— 0.1',
                'Step 4: Î”Tb = 0.0512 Â°C',
                'Step 5: New boiling point = 100 + 0.0512 = 100.0512 Â°C'
            ],
            answer: 'Molality = 0.1 m; Î”Tb = 0.0512 Â°C',
            notes: 'Glucose is a non-electrolyte, so the van\'t Hoff factor i = 1. For electrolytes like NaCl, Î”Tb = iÂ·KbÂ·m where i â‰ˆ 2 (accounting for dissociation into Naâº and Clâ» ions).'
        }
    ],

    // ===== CSIR-UGC NET PHYSICS â€” 5 Problems ================================
    'csir-net': [
        {
            id: 1,
            exam: 'csir-net',
            chapter: 'Mathematical Physics',
            topic: 'Contour Integration â€“ Cauchy Residue Theorem',
            difficulty: 'moderate',
            year: null,
            question: 'Evaluate the contour integral âˆ® dz/(zÂ² + 1) around the circle |z| = 2 in the complex plane, traversed counterclockwise.',
            given: 'Given: f(z) = 1/(zÂ² + 1), contour C: |z| = 2 (counterclockwise)',
            required: 'Find: âˆ®_C dz/(zÂ² + 1)',
            formula: '$$\\oint_C \\frac{dz}{z^2+1} = 2\\pi i \\sum \\text{Res}(f, z_k)$$',
            steps: [
                'Step 1: Factor the denominator: zÂ² + 1 = (z âˆ’ i)(z + i)',
                'Step 2: Singularities at z = i and z = âˆ’i. Both lie inside |z| = 2.',
                'Step 3: Residue at z = i: Res(f, i) = lim_{zâ†’i} (zâˆ’i)Â·1/((zâˆ’i)(z+i)) = 1/(2i)',
                'Step 4: Residue at z = âˆ’i: Res(f, âˆ’i) = lim_{zâ†’âˆ’i} (z+i)Â·1/((zâˆ’i)(z+i)) = 1/(âˆ’2i) = âˆ’1/(2i)',
                'Step 5: Sum of residues = 1/(2i) + (âˆ’1/(2i)) = 0',
                'Step 6: âˆ® dz/(zÂ²+1) = 2Ï€i Ã— 0 = 0'
            ],
            answer: 'âˆ® dz/(zÂ² + 1) = 0',
            notes: 'When all singularities inside the contour have residues that sum to zero, the integral vanishes. Alternatively, note that 1/(zÂ²+1) has an antiderivative arctan(z) which is single-valued on this contour, giving zero by the fundamental theorem.'
        },
        {
            id: 2,
            exam: 'csir-net',
            ...
            difficulty: 'advanced',
            year: null,
            question: 'For the ground state of a one-dimensional quantum harmonic oscillator with angular frequency Ï‰, calculate the expectation value âŸ¨xÂ²âŸ©.',
            given: 'Given: QHO ground state Ïˆâ‚€(x) = (mÏ‰/Ï€â„)^(1/4) exp(âˆ’mÏ‰xÂ²/2â„), angular frequency Ï‰, mass m',
            required: 'Find: âŸ¨xÂ²âŸ© = âŸ¨Ïˆâ‚€|xÂ²|Ïˆâ‚€âŸ©',
            formula: '$$\\langle x^2 \\rangle = \\frac{\\hbar}{2m\\omega}$$',
            steps: [
                'Step 1: Express x in terms of raising/lowering operators: x = âˆš(â„/2mÏ‰)(a + aâ€ )',
                'Step 2: xÂ² = (â„/2mÏ‰)(a + aâ€ )Â² = (â„/2mÏ‰)(aÂ² + aâ€ Â² + aaâ€  + aâ€ a)',
                'Step 3: âŸ¨0|aÂ²|0âŸ© = 0, âŸ¨0|aâ€ Â²|0âŸ© = 0, âŸ¨0|aâ€ a|0âŸ© = 0 (ground state has n=0)',
                'Step 4: âŸ¨0|aaâ€ |0âŸ© = âŸ¨0|(aâ€ a + 1)|0âŸ© = âŸ¨0|0âŸ© = 1',
                'Step 5: âŸ¨xÂ²âŸ© = (â„/2mÏ‰)(0 + 0 + 1 + 0) = â„/(2mÏ‰)'
            ],
            answer: 'âŸ¨xÂ²âŸ© = â„/(2mÏ‰)',
            notes: 'This result is consistent with the uncertainty principle: Î”xÎ”p = â„/2 for the ground state (minimum uncertainty state). The ground-state energy Eâ‚€ = Â½â„Ï‰ equals Â½mÏ‰Â²âŸ¨xÂ²âŸ© + âŸ¨pÂ²âŸ©/(2m), with each contribution being â„Ï‰/4.'
        },
        {
            id: 3,
            exam: 'csir-net',
            ...
            difficulty: 'moderate',
            year: null,
            question: 'A system has two non-degenerate energy levels with energies E = 0 and E = Îµ. Find the partition function Z and the mean energy âŸ¨EâŸ© at temperature T.',
            given: 'Given: Two levels with energies 0 and Îµ, temperature T, Boltzmann constant k_B',
            required: 'Find: Partition function Z and mean energy âŸ¨EâŸ©',
            formula: '$$Z = \\sum_i e^{-\\beta E_i}, \\quad \\langle E \\rangle = -\\frac{\\partial \\ln Z}{\\partial \\beta}$$',
            steps: [
                'Step 1: Partition function: Z = e^{âˆ’Î²Â·0} + e^{âˆ’Î²Îµ} = 1 + e^{âˆ’Î²Îµ}, where Î² = 1/(k_BT)',
                'Step 2: Mean energy: âŸ¨EâŸ© = (1/Z) Î£ Eáµ¢ e^{âˆ’Î²Eáµ¢} = (0Â·1 + ÎµÂ·e^{âˆ’Î²Îµ}) / (1 + e^{âˆ’Î²Îµ})',
                'Step 3: âŸ¨EâŸ© = ÎµÂ·e^{âˆ’Î²Îµ} / (1 + e^{âˆ’Î²Îµ}) = Îµ / (e^{Î²Îµ} + 1)',
                'Step 4: At low T (Î²Îµ â‰« 1): âŸ¨EâŸ© â†’ ÎµÂ·e^{âˆ’Îµ/k_BT} â‰ˆ 0 (system in ground state)',
                'Step 5: At high T (Î²Îµ â‰ª 1): âŸ¨EâŸ© â†’ Îµ/2 (equal population of both levels)'
            ],
            answer: 'Z = 1 + e^{âˆ’Îµ/k_BT}; âŸ¨EâŸ© = Îµ/(e^{Îµ/k_BT} + 1)',
            notes: 'The two-level system is the simplest non-trivial statistical mechanics model. The mean energy expression has the form of the Fermiâ€“Dirac distribution. The heat capacity of this system exhibits the famous Schottky anomaly â€” a peak at k_BT â‰ˆ 0.42Îµ.'
        },
        {
            id: 4,
            exam: 'csir-net',
            ...
            difficulty: 'easy',
            year: null,
            question: 'Calculate the Q-value of the alpha decay: Â²Â³â¸U â†’ Â²Â³â´Th + â´He. Given atomic masses: M(Â²Â³â¸U) = 238.05079 u, M(Â²Â³â´Th) = 234.04363 u, M(â´He) = 4.00260 u.',
            given: 'Given: M(Â²Â³â¸U) = 238.05079 u, M(Â²Â³â´Th) = 234.04363 u, M(â´He) = 4.00260 u, 1 u = 931.5 MeV/cÂ²',
            required: 'Find: Q-value of the alpha decay',
            formula: '$$Q = [M(\\text{parent}) - M(\\text{daughter}) - M(\\alpha)] \\times 931.5 \\text{ MeV}$$',
            steps: [
                'Step 1: Mass defect Î”m = M(Â²Â³â¸U) âˆ’ M(Â²Â³â´Th) âˆ’ M(â´He)',
                'Step 2: Î”m = 238.05079 âˆ’ 234.04363 âˆ’ 4.00260 = 0.00456 u',
                'Step 3: Q = Î”m Ã— 931.5 MeV/u = 0.00456 Ã— 931.5',
                'Step 4: Q = 4.25 MeV'
            ],
            answer: 'Q â‰ˆ 4.25 MeV',
            notes: 'The positive Q-value confirms that the decay is energetically favourable. This energy is shared between the alpha particle (kinetic energy â‰ˆ 4.19 MeV) and the recoiling thorium nucleus (â‰ˆ 0.07 MeV) according to conservation of momentum. Â²Â³â¸U has a half-life of 4.47 Ã— 10â¹ years.'
        },
        {
            id: 5,
            exam: 'csir-net',
            ...
            difficulty: 'moderate',
            year: null,
            question: 'Calculate the Fermi energy of sodium metal using the free electron model. The number density of conduction electrons in sodium is n = 2.65 Ã— 10Â²â¸ mâ»Â³.',
            given: 'Given: n = 2.65 Ã— 10Â²â¸ mâ»Â³, â„ = 1.055 Ã— 10â»Â³â´ JÂ·s, m_e = 9.109 Ã— 10â»Â³Â¹ kg',
            required: 'Find: Fermi energy E_F',
            formula: '$$E_F = \\frac{\\hbar^2}{2m_e}(3\\pi^2 n)^{2/3}$$',
            steps: [
                'Step 1: Calculate 3Ï€Â²n = 3 Ã— (3.1416)Â² Ã— 2.65 Ã— 10Â²â¸ = 3 Ã— 9.87 Ã— 2.65 Ã— 10Â²â¸ = 7.846 Ã— 10Â²â¹ mâ»Â³',
                'Step 2: (3Ï€Â²n)^{2/3} = (7.846 Ã— 10Â²â¹)^{2/3}',
                'Step 3: (7.846)^{2/3} â‰ˆ 3.93 and (10Â²â¹)^{2/3} = 10^{19.33} â‰ˆ 8.48 Ã— 10Â¹â¹',
                'Step 4: â„Â²/(2m_e) = (1.055 Ã— 10â»Â³â´)Â² / (2 Ã— 9.109 Ã— 10â»Â³Â¹) = 1.113 Ã— 10â»â¶â¸ / 1.822 Ã— 10â»Â³â° = 6.11 Ã— 10â»Â³â¹ JÂ·mÂ²',
                'Step 5: E_F = 6.11 Ã— 10â»Â³â¹ Ã— 3.93 Ã— 8.48 Ã— 10Â¹â¹ = 5.19 Ã— 10â»Â¹â¹ J â‰ˆ 3.24 eV'
            ],
            answer: 'E_F â‰ˆ 3.24 eV',
            notes: 'Sodium is a nearly free electron metal (one 3s electron per atom). The Fermi temperature T_F = E_F/k_B â‰ˆ 37,600 K, far above room temperature, justifying the degenerate electron gas approximation. The Fermi velocity v_F = âˆš(2E_F/m) â‰ˆ 1.07 Ã— 10â¶ m/s.'
        }
    ],

    // ===== GATE PHYSICS â€” 5 Problems =========================================
    'gate-physics': [
        {
            id: 1,
            exam: 'gate-physics',
            ...
            difficulty: 'moderate',
            year: '2022',
            question: 'A plane electromagnetic wave has an electric field amplitude Eâ‚€ = 100 V/m. Find the magnetic field amplitude Bâ‚€ and the intensity of the wave.',
            given: 'Given: Eâ‚€ = 100 V/m, c = 3 Ã— 10â¸ m/s, Îµâ‚€ = 8.854 Ã— 10â»Â¹Â² F/m',
            required: 'Find: Magnetic field amplitude Bâ‚€ and intensity I',
            formula: '$$B_0 = \\frac{E_0}{c}, \\quad I = \\frac{1}{2}\\varepsilon_0 c E_0^2$$',
            steps: [
                'Step 1: In an EM wave, E and B are related by: Bâ‚€ = Eâ‚€/c',
                'Step 2: Bâ‚€ = 100 / (3 Ã— 10â¸) = 3.33 Ã— 10â»â· T = 0.333 Î¼T',
                'Step 3: Intensity (time-averaged Poynting vector): I = Â½Îµâ‚€cEâ‚€Â²',
                'Step 4: I = Â½ Ã— 8.854 Ã— 10â»Â¹Â² Ã— 3 Ã— 10â¸ Ã— (100)Â²',
                'Step 5: I = Â½ Ã— 8.854 Ã— 10â»Â¹Â² Ã— 3 Ã— 10â¸ Ã— 10â´ = 13.28 W/mÂ²'
            ],
            answer: 'Bâ‚€ â‰ˆ 3.33 Ã— 10â»â· T (0.333 Î¼T); I â‰ˆ 13.3 W/mÂ²',
            notes: 'The electric and magnetic field energy densities are equal in an EM wave: Â½Îµâ‚€Eâ‚€Â² = Â½Bâ‚€Â²/Î¼â‚€. The intensity can also be written as I = Eâ‚€Bâ‚€/(2Î¼â‚€). These relations are fundamental in GATE EM theory questions.'
        },
        {
            id: 2,
            exam: 'gate-physics',
            chapter: 'Quantum Mechanics',
            topic: 'Hydrogen Atom â€“ Radial Probability',
            difficulty: 'moderate',
            year: '2023',
            question: 'For the ground state (1s) of the hydrogen atom, calculate the probability of finding the electron within one Bohr radius aâ‚€ from the nucleus.',
            given: 'Given: Ground state wavefunction Ïˆâ‚â‚› = (1/âˆšÏ€)(1/aâ‚€)^{3/2} e^{âˆ’r/aâ‚€}, Bohr radius aâ‚€',
            required: 'Find: P(r â‰¤ aâ‚€) = âˆ«â‚€^{aâ‚€} |Ïˆ|Â² 4Ï€rÂ² dr',
            formula: '$$P = \\frac{4}{a_0^3} \\int_0^{a_0} r^2 e^{-2r/a_0} dr$$',
            steps: [
                'Step 1: Radial probability density: P(r)dr = |Ïˆ|Â² Â· 4Ï€rÂ² dr = (4/aâ‚€Â³) rÂ² e^{âˆ’2r/aâ‚€} dr',
                'Step 2: Let x = 2r/aâ‚€, then r = aâ‚€x/2, dr = aâ‚€dx/2. When r = aâ‚€, x = 2.',
                'Step 3: P = (4/aâ‚€Â³) Ã— (aâ‚€/2)Â³ âˆ«â‚€Â² xÂ² e^{âˆ’x} (aâ‚€/2) dx... Simplifying: P = Â½ âˆ«â‚€Â² xÂ² e^{âˆ’x} dx',
                'Step 4: âˆ«â‚€Â² xÂ²e^{âˆ’x}dx = [âˆ’xÂ²e^{âˆ’x}]â‚€Â² + 2âˆ«â‚€Â² xe^{âˆ’x}dx = âˆ’4eâ»Â² + 2[âˆ’xe^{âˆ’x} + âˆ«e^{âˆ’x}dx]â‚€Â² = âˆ’4eâ»Â² + 2[âˆ’2eâ»Â² âˆ’ eâ»Â² + 1] = âˆ’4eâ»Â² + 2(1 âˆ’ 3eâ»Â²) = 2 âˆ’ 10eâ»Â²',
                'Step 5: P = Â½(2 âˆ’ 10eâ»Â²) = 1 âˆ’ 5eâ»Â² = 1 âˆ’ 5(0.1353) = 1 âˆ’ 0.677 = 0.323'
            ],
            answer: 'P(r â‰¤ aâ‚€) â‰ˆ 0.323 or 32.3%',
            notes: 'There is only about a 32% chance of finding the electron within one Bohr radius. The most probable radius (peak of radial probability) is r = aâ‚€, but the mean radius âŸ¨râŸ© = 3aâ‚€/2. This illustrates the spread of the quantum probability distribution.'
        },
        {
            id: 3,
            exam: 'gate-physics',
            chapter: 'Thermodynamics',
            topic: 'Free Expansion â€“ Entropy Change',
            difficulty: 'easy',
            year: '2022',
            ...
            given: 'Given: n = 1 mol, Vâ‚‚ = 2Vâ‚, Free expansion (irreversible), R = 8.314 J/(molÂ·K)',
            required: 'Find: Entropy change Î”S',
            formula: '$$\\Delta S = nR\\ln\\frac{V_2}{V_1}$$',
            steps: [
                'Step 1: In free expansion: Q = 0, W = 0, Î”U = 0 (for ideal gas, T is unchanged)',
                'Step 2: Since entropy is a state function, we compute Î”S via a reversible path between the same states.',
                'Step 3: Choose a reversible isothermal expansion from Vâ‚ to Vâ‚‚ at temperature T.',
                'Step 4: For this reversible path: Î”S = nR ln(Vâ‚‚/Vâ‚) = 1 Ã— 8.314 Ã— ln(2)',
                'Step 5: Î”S = 8.314 Ã— 0.693 = 5.76 J/K'
            ],
            answer: 'Î”S = nR ln 2 â‰ˆ 5.76 J/K',
            notes: 'Free expansion is irreversible, so Î”S_total > 0. Since no heat is exchanged with surroundings, Î”S_surroundings = 0, and the entire entropy increase is in the gas. This is a classic example of the second law of thermodynamics.'
        },
        {
            id: 4,
            exam: 'gate-physics',
            ...
            difficulty: 'moderate',
            year: '2023',
            question: 'A body-centred cubic (BCC) crystal has a lattice constant a = 3.16 Ã…. Find the nearest-neighbour distance between atoms.',
            given: 'Given: Crystal structure: BCC, Lattice constant a = 3.16 Ã… = 3.16 Ã— 10â»Â¹â° m',
            ...
            steps: [
                ...
                'Step 2: The body diagonal of the cube has length aâˆš3.',
                'Step 3: The nearest-neighbour distance is half the body diagonal: d = aâˆš3/2',
                'Step 4: d = 3.16 Ã— âˆš3 / 2 = 3.16 Ã— 1.732 / 2 = 5.473 / 2 = 2.737 Ã…'
            ],
            answer: 'd â‰ˆ 2.74 Ã…',
            notes: 'In BCC, the coordination number is 8 (each atom has 8 nearest neighbours). For FCC, the nearest-neighbour distance is a/âˆš2, and the coordination number is 12. Tungsten (W) is a common example of a BCC metal with a = 3.16 Ã….'
        },
        {
            id: 5,
            exam: 'gate-physics',
            ...
            difficulty: 'easy',
            year: '2021',
            question: 'Estimate the radius of the âµâ¶Fe (iron-56) nucleus using the empirical nuclear radius formula.',
            given: 'Given: Mass number A = 56, Râ‚€ = 1.2 fm = 1.2 Ã— 10â»Â¹âµ m',
            required: 'Find: Nuclear radius R',
            formula: '$$R = R_0 A^{1/3}$$',
            steps: [
                'Step 1: Apply the empirical formula: R = Râ‚€ Ã— A^{1/3}',
                'Step 2: A^{1/3} = 56^{1/3} = (56)^{0.333}',
                'Step 3: 56^{1/3} â‰ˆ 3.826 (since 3.826Â³ â‰ˆ 56)',
                'Step 4: R = 1.2 Ã— 3.826 = 4.59 fm'
            ],
            answer: 'R â‰ˆ 4.59 fm (4.59 Ã— 10â»Â¹âµ m)',
            notes: 'The nuclear radius scales as A^{1/3}, implying constant nuclear density Ï = 3m_p/(4Ï€Râ‚€Â³) â‰ˆ 2.3 Ã— 10Â¹â· kg/mÂ³ across all nuclei. This extraordinary density is comparable to neutron star matter. âµâ¶Fe has the highest binding energy per nucleon among all nuclides.'
        }
    ],

    // ===== CUET SCIENCE â€” 5 Problems =========================================
    'cuet-science': [
        {
            id: 1,
            exam: 'cuet-science',
            ...
            difficulty: 'easy',
            year: null,
            question: 'An object is dropped from a height of 80 m. Neglecting air resistance, find the time it takes to reach the ground. (g = 9.8 m/sÂ²)',
            given: 'Given: Height h = 80 m, Initial velocity u = 0 (dropped), g = 9.8 m/sÂ²',
            required: 'Find: Time t to reach the ground',
            formula: '$$h = \\frac{1}{2}gt^2 \\implies t = \\sqrt{\\frac{2h}{g}}$$',
            steps: [
                'Step 1: Use the kinematic equation for free fall: h = Â½gtÂ² (since u = 0)',
                'Step 2: Solve for t: t = âˆš(2h/g)',
                'Step 3: t = âˆš(2 Ã— 80 / 9.8) = âˆš(160/9.8) = âˆš(16.33)',
                'Step 4: t = 4.04 s'
            ],
            answer: 't â‰ˆ 4.04 s',
            notes: 'In free fall, the velocity just before hitting the ground would be v = gt = 9.8 Ã— 4.04 â‰ˆ 39.6 m/s (about 143 km/h). In reality, air resistance would reduce this significantly for most objects.'
        },
        {
            id: 2,
            exam: 'cuet-science',
            ...
            difficulty: 'easy',
            year: null,
            question: '500 g of water is heated from 20Â°C to 80Â°C. Calculate the amount of heat energy required. (Specific heat of water c = 4.18 J/gÂ·Â°C)',
            given: 'Given: Mass m = 500 g, Initial temperature Tâ‚ = 20Â°C, Final temperature Tâ‚‚ = 80Â°C, c = 4.18 J/(gÂ·Â°C)',
            required: 'Find: Heat energy Q required',
            formula: '$$Q = mc\\Delta T$$',
            steps: [
                'Step 1: Temperature change: Î”T = Tâ‚‚ âˆ’ Tâ‚ = 80 âˆ’ 20 = 60Â°C',
                'Step 2: Apply Q = mcÎ”T',
                'Step 3: Q = 500 Ã— 4.18 Ã— 60',
                'Step 4: Q = 125,400 J = 125.4 kJ'
            ],
            answer: 'Q = 125,400 J = 125.4 kJ',
            notes: 'This is equivalent to about 30 food Calories (kcal). Water has one of the highest specific heat capacities of any common substance (4.18 J/gÂ·Â°C), which is why it\'s used as a coolant and why coastal climates are milder.'
        },
        {
            id: 3,
            exam: 'cuet-science',
            ...
            difficulty: 'easy',
            year: null,
            question: 'The fundamental frequency of a vibrating string is fâ‚ = 200 Hz. Find the frequencies of the second and third harmonics.',
            given: 'Given: Fundamental frequency fâ‚ = 200 Hz',
            required: 'Find: Second harmonic fâ‚‚ and third harmonic fâ‚ƒ',
            formula: '$$f_n = n \\cdot f_1$$',
            steps: [
                'Step 1: For a vibrating string, the nth harmonic has frequency fâ‚™ = n Ã— fâ‚',
                'Step 2: Second harmonic (first overtone): fâ‚‚ = 2 Ã— fâ‚ = 2 Ã— 200 = 400 Hz',
                'Step 3: Third harmonic (second overtone): fâ‚ƒ = 3 Ã— fâ‚ = 3 Ã— 200 = 600 Hz'
            ],
            answer: 'fâ‚‚ = 400 Hz, fâ‚ƒ = 600 Hz',
            notes: 'A vibrating string supports all harmonics (both odd and even). An open pipe also supports all harmonics, but a closed pipe supports only odd harmonics (fâ‚, 3fâ‚, 5fâ‚, ...). The fundamental frequency depends on length, tension, and linear mass density: fâ‚ = (1/2L)âˆš(T/Î¼).'
        },
        {
            id: 4,
            exam: 'cuet-science',
            ...
            difficulty: 'easy',
            year: null,
            question: 'A 12 V battery is connected across a resistor of 4 Î©. Find the current flowing through the resistor and the power dissipated.',
            given: 'Given: Voltage V = 12 V, Resistance R = 4 Î©',
            required: 'Find: Current I and Power P',
            formula: '$$I = \\frac{V}{R}, \\quad P = VI = I^2R = \\frac{V^2}{R}$$',
            steps: [
                'Step 1: Apply Ohm\'s law: I = V/R = 12/4 = 3 A',
                'Step 2: Power dissipated: P = V Ã— I = 12 Ã— 3 = 36 W',
                'Step 3: Verify: P = IÂ²R = 9 Ã— 4 = 36 W âœ“',
                'Step 4: Also: P = VÂ²/R = 144/4 = 36 W âœ“'
            ],
            answer: 'I = 3 A, P = 36 W',
            notes: 'All three power formulas (P = VI, P = IÂ²R, P = VÂ²/R) give the same result. 36 W means the resistor converts 36 joules of electrical energy to heat every second. This is equivalent to a small light bulb.'
        },
        {
            id: 5,
            exam: 'cuet-science',
            chapter: 'Modern Physics',
            topic: 'Photoelectric Effect â€“ Stopping Potential',
            difficulty: 'moderate',
            year: null,
            question: 'Ultraviolet light of wavelength 200 nm is incident on a metal surface with work function Ï† = 4.2 eV. Find the maximum kinetic energy of the emitted photoelectrons and the stopping potential.',
            given: 'Given: Î» = 200 nm = 200 Ã— 10â»â¹ m, Ï† = 4.2 eV, h = 6.626 Ã— 10â»Â³â´ JÂ·s, c = 3 Ã— 10â¸ m/s, 1 eV = 1.6 Ã— 10â»Â¹â¹ J',
            required: 'Find: Maximum KE and stopping potential Vâ‚€',
            formula: '$$KE_{\\max} = \\frac{hc}{\\lambda} - \\phi, \\quad eV_0 = KE_{\\max}$$',
            steps: [
                'Step 1: Energy of incident photon: E = hc/Î»',
                'Step 2: Using hc = 1240 eVÂ·nm: E = 1240/200 = 6.2 eV',
                'Step 3: Maximum KE: KE_max = E âˆ’ Ï† = 6.2 âˆ’ 4.2 = 2.0 eV',
                'Step 4: Stopping potential: eVâ‚€ = KE_max, so Vâ‚€ = 2.0 eV / e = 2.0 V'
            ],
            answer: 'KE_max = 2.0 eV; Stopping potential Vâ‚€ = 2.0 V',
            notes: 'The stopping potential is numerically equal to the maximum KE in electron-volts. The shortcut hc = 1240 eVÂ·nm is extremely useful for quick calculations. Photoemission occurs only when E > Ï†, i.e., Î» < hc/Ï† = 1240/4.2 = 295 nm (UV threshold).'
        }
    ]
};
...
function initExamPage() {
    ...
    // Set page title
    document.title = `${exam.title} â€” ${exam.subtitle || 'Numerical Solutions'} | JeetPhysics`;
 ...
 * @param {Object} exam â€” The exam configuration object.
 */
...
function renderSidebar(exam) {
    ...
    // Popular questions â€” first 3 problems
    ...
    // Recent questions â€” last 2 problems
    ...
    sidebarEl.innerHTML = `
        <div class="sidebar-section">
            <h3 class="sidebar-heading">ðŸ”¥ Popular Questions</h3>
            ${popularHTML}
        </div>
        <div class="sidebar-section">
            <h3 class="sidebar-heading">ðŸ• Recently Added</h3>
            ${recentHTML}
        </div>
        <div class="sidebar-section">
            <h3 class="sidebar-heading">âš¡ Quick Links</h3>
            <div class="sidebar-links-list">
                ${quickLinksHTML}
            </div>
        </div>
        <div class="sidebar-section">
            <h3 class="sidebar-heading">ðŸ“¥ Downloads</h3>
 ...
 * Includes pagination.
 * @param {Array} problems â€” Array of problem objects to render.
 */
        ...
        return `
            <div class="problem-card" id="problem-${p.id}" data-chapter="${p.chapter}" data-difficulty="${p.difficulty}">
                ...
                <button class="btn-toggle-solution" onclick="toggleSolution(${p.id})">
                    <span class="toggle-icon" id="toggle-icon-${p.id}">â–¶</span>
                    Show Solution
                </button>

                <div class="solution-panel" id="solution-${p.id}" style="display: none;">
                    <h4>ðŸ“ Step-by-Step Solution</h4>
 ...
 * @param {string|null} chapter â€” Chapter name or null for all.
 * @param {string|null} difficulty â€” 'easy', 'moderate', 'advanced', or null.
 * @param {string|null} query â€” Search text or null.
 */
 ...
 * @param {Array} problems â€” Full array of problems.
 * @param {number} page â€” Current page number (1-indexed).
 * @param {number} perPage â€” Number of items per page.
 * @returns {Array} â€” Sliced array for the current page.
 */
 ...
 * @param {number} totalProblems â€” Total number of problems after filtering.
 */
 ...
 * @param {number} page â€” Target page number.
 */
 ...
 * @param {number} id â€” The problem ID.
 */
function toggleSolution(id) {
    ...
    if (btn) {
        btn.innerHTML = `<span class="toggle-icon" id="toggle-icon-${id}">${isHidden ? 'â–¼' : 'â–¶'}</span> ${isHidden ? 'Hide' : 'Show'} Solution`;
    }
 ...
 * @param {string} chapter â€” Chapter name.
 */
...
function initFilters(exam) {
    ...
    filtersContainer.innerHTML = `
        <div class="filter-group">
            <div class="filter-label">ðŸ“š Chapter</div>
            <div class="filter-pills chapter-filters">${chapterBtnsHTML}</div>
        </div>
        <div class="filter-group">
            <div class="filter-label">ðŸ“Š Difficulty</div>
 ...
 * @param {HTMLElement} btn â€” The clicked button element.
 */
...
// ---------------------------------------------------------------------------
//  HELPER FUNCTIONS â€” Get active filter values
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
//  4. DOM CONTENT LOADED â€” Bootstrap the exam page
// ---------------------------------------------------------------------------
